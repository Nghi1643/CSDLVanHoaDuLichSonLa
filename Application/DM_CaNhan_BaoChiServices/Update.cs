                ...
                using (SqlConnection connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    using (var transaction = connection.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            var result = await connection.QueryFirstOrDefaultAsync<DM_CaNhan>("spu_DM_CaNhan_Update", parameters, commandType: CommandType.StoredProcedure, transaction: transaction);
                            ...
                            if (result != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    var resultRelation = await connection.QueryFirstOrDefaultAsync<DM_CaNhan_BaoChi>("spu_DM_CaNhan_BaoChi_Update", parametersRelation, commandType: CommandType.StoredProcedure, transaction: transaction);
                                }
                                catch (Exception ex)
                                {
                                    transaction.Rollback();
