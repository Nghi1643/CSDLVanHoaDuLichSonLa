                ...
                using (SqlConnection connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    using (var transaction = connection.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            var result = await connection.QueryFirstOrDefaultAsync<DM_CaNhan>("spu_DM_CaNhan_TheThao_Update", parameters, commandType: CommandType.StoredProcedure, transaction: transaction);
