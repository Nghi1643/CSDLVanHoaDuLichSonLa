...
namespace Application.DM_CaNhan_TrongTaiServices
{
    public class Add
    {
        ...
        {
            public DM_CaNhan_TrongTaiRequestHandleInfo Entity;
                        ...
                        try
                        {
                            ...
                            if (result != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    parametersVDV.Add("@CapBacID", request.Entity.CapBacID);
                                    parametersVDV.Add("@NamKinhNghiem", request.Entity.NamKinhNghiem);
                                    var resultVDV = await connection.QueryFirstOrDefaultAsync<DM_CaNhan_VanDongVien_NoiDung>("spu_DM_CaNhan_TrongTai_HandleInfo", parametersVDV, commandType: CommandType.StoredProcedure, transaction: transaction);
                                }
                                catch (Exception ex)
                                {
                                    transaction.Rollback();
