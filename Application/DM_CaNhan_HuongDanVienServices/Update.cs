                ...
                using (SqlConnection connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
                {
                    ...
                    using (var transaction = connection.BeginTransaction())
                    {
                        ...
                        try
                        {
                            ...
                            var result = await connection.QueryFirstOrDefaultAsync<DM_CaNhan_HuongDanVien>("spu_DM_CaNhan_Update", parameters, commandType: CommandType.StoredProcedure, transaction: transaction);
