...
function loadData(nhanSuId) {
    // Load thông tin vận động viên
    getDataWithApi('GET', `/api/DM_CaNhan_VanDongVienApi/Get?CaNhanID=${nhanSuId}&maNgonNgu=vi`).then(data => {
...
function initTableTheThao(nhanSuId) {
    const tableApi = {
        url: `${baseUrl}/api/DM_CaNhan_VanDongVienApi/GetListMon?CaNhanID=${nhanSuId}&maNgonNgu=vi`,
        type: "GET",
