...
function initTable() {
    const tableApi = {
        ...
        data: function (d) {
            ...
            return JSON.stringify({
                loaiToChucID: 96, // ID cho liên đoàn
    ...
    const tableDefs = [
        {
            ...
            render: function (data, type, row, meta) {
                return `<div class="group-info">
                    <div class="info-main">
                        <a href="${baseUrl}/AdminTool/LienDoan/Details?id=${row.toChucID}" class="text-primary text-decoration-none">
                            ${row.tenToChuc || ''}
                        </a>
                    </div>
        ...
        },
        {
            ...
            render: function (data, type, row, meta) {
                return `<div class="group-info">
                    <div class="info-main">
                        <a href="${baseUrl}/AdminTool/LienDoan/AnPhamKenhPhatSong?id=${row.toChucID}" class="text-primary text-decoration-none">
        ...
        },
        {
            ...
            render: function (data, type, row, meta) {
                let html = "";
                if (permitedEdit) {
                    html += `<a href="${baseUrl}/AdminTool/LienDoan/Add?id=${row.toChucID}" data-toggle="tooltip" title="Chỉnh sửa" class="text-yellow me-2">
    ...
    const tableCols = [
        ...
        { "data": "soLuongCanBo", "width": "10%", "class": "center-align" },
