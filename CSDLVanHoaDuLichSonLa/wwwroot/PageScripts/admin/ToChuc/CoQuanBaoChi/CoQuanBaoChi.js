...
$(document).ready(function () {
    ...
    async function initTable() {
        const tableApi = {
            ...
            data: function (d) {
                ...
                var linhVucID = $('#loai-hinh-search').val()
                ...
                return JSON.stringify({
                    ...
                    linhVucID: linhVucID == "-1" ? null : coQuanChuQuanID,
                    phamViHoatDongID: phamViHoatDongID == "-1" ? null : coQuanChuQuanID,
                    trangThaiID: suDung == "-1" ? null : Number(suDung),
                    maNgonNgu: maNgonNgu == "-1" ? null : coQuanChuQuanID
                });
            },
    ...
    async function initLoaiHinhBaoChi() {
        try {
            ...
            if (data && data.isSuccess && data.value) {
                ...
                data.value.forEach(itemBaoChi => {
                    $("#loai-hinh-search").append(`<option value="${itemBaoChi.danhMucID}">${itemBaoChi.tenDanhMuc}</option>`);
                });
