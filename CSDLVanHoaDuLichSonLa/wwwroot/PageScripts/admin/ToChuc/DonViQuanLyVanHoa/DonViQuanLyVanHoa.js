...
$(document).ready(function () {
    initDatePicker();
    initDanhMucChung(20, "#loai-hinh-search", "")
...
function initTable() {
    const tableApi = {
        ...
        data: function (d) {
            ...
            return JSON.stringify({
                loaiToChucID: 122, // ID cho đơn vị quản lý văn hóa
    ...
    const tableDefs = [
        {
            ...
            render: function (data, type, row, meta) {
                return `<div class="group-info">
                    <div class="info-main">
                        <a href="${baseUrl}/AdminTool/DonViQuanLyVanHoa/Details?id=${row.toChucID}" class="text-primary text-decoration-none">
                            ${row.tenToChuc || ''}
                        </a>
                    </div>
        ...
        },
        {
            targets: 3, 
            render: function (data, type, row, meta) {
                return formatYear(row.ngayThanhLap);
            }
        },
        {
            targets: 4, // Cột Giải thưởng
            render: function (data, type, row, meta) {
                return `<div class="group-info">
                    <div class="info-main">
                        <a href="${baseUrl}/AdminTool/DonViQuanLyVanHoa/AnPhamKenhPhatSong?id=${row.toChucID}" class="text-primary text-decoration-none">
        ...
        },
        {
            ...
            render: function (data, type, row, meta) {
                let html = "";
                if (permitedEdit) {
                    html += `<a href="${baseUrl}/AdminTool/DonViQuanLyVanHoa/Add?id=${row.toChucID}" data-toggle="tooltip" title="Chỉnh sửa" class="text-yellow me-2">
    ...
    const tableCols = [
        ...
        { "data": "soLuongGiaiThuong", "width": "12%", "class": "center-align name-text" },
