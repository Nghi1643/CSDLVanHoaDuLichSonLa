...
$(document).ready(function () {
        ...
        const tableApi = {
            ...
            data: function (d) {
                ...
                return JSON.stringify({
                    loaiToChucID: 99, // ID cho bảo tàng
        ...
        const tableDefs = [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return `<div class="group-info">
                        <div class="info-main">
                            <a href="${baseUrl}/AdminTool/BaoTang/GiaiThuongDanhHieu?id=${row.toChucID}" class="text-primary text-decoration-none">
    ...
    async function initLoaiHinhBaoTang() {
        try {
            const res = await fetch(`${baseUrl}/api/DanhMucChungApi/DanhSach`, {
                ...
                body: JSON.stringify({
                    loaiDanhMucID: "23", // Loại hình bảo tàng
                    trangThai: true
                })
            })
