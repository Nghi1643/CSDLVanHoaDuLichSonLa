...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình di sản văn hoá <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình di sản văn hoá");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình di sản văn hoá ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình di sản văn hoá <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình di sản văn hoá");
        $('#modalAddTitle').text("Thêm mới tên loại hình di sản văn hoá")
        $('#maSoHide').removeClass('d-none')
