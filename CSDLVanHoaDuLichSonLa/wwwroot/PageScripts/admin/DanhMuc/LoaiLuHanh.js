...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại lữ hành <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại lữ hành");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại lữ hành ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại lữ hành <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại lữ hành");
        $('#modalAddTitle').text("Thêm mới tên loại lữ hành")
        $('#maSoHide').removeClass('d-none')
