...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình doanh nghiệp <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình doanh nghiệp");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình doanh nghiệp ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình doanh nghiệp <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình doanh nghiệp");
        $('#modalAddTitle').text("Thêm mới tên loại hình doanh nghiệp")
        $('#maSoHide').removeClass('d-none')
