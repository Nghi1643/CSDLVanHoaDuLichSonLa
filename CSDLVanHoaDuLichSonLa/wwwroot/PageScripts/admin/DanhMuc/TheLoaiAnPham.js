...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên thể loại ẩn phẩm <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên thể loại ẩn phẩm");
            $('#modalAddTitle').text(`Chỉnh sửa tên thể loại ẩn phẩm ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên thể loại ấn phẩm <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên thể loại ẩn phẩm");
        $('#modalAddTitle').text("Thêm mới tên thể loại ẩn phẩm")
        $('#maSoHide').removeClass('d-none')
