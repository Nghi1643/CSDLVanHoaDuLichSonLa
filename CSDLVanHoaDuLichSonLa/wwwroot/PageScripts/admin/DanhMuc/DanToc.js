...
$(document).ready(function () {
    ...
    function initValidation() {
        // Validation cho form Add và Edit
...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên dân tộc <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên dân tộc");
            $('#modalAddTitle').text(`Chỉnh sửa tên dân tộc ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên dân tộc <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên dân tộc");
        $('#modalAddTitle').text("Thêm mới tên dân tộc")
        $('#maSoHide').removeClass('d-none')
    ...
    $("#modalAdd").on('hide.bs.modal', function () {
        ...
        RemoveFalseInput(document.getElementById('tenDanhMucAdd'));
        RemoveFalseInput(document.getElementById('moTaAdd'));
