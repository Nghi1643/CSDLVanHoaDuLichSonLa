...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại tour du lịch <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại tour du lịch");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại tour du lịch ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại tour du lịch <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại tour du lịch");
        $('#modalAddTitle').text("Thêm mới tên loại tour du lịch")
        $('#maSoHide').removeClass('d-none')
