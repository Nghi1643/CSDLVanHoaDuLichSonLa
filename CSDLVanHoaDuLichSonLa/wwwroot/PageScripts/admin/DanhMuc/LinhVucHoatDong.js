...
$(document).ready(function () {
    ...
    async function initTable() {
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên lĩnh vực hoạt động <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên lĩnh vực hoạt động");
            $('#modalAddTitle').text(`Chỉnh sửa tên lĩnh vực hoạt động ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên lĩnh vực hoạt động <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên lĩnh vực hoạt động");
        $('#modalAddTitle').text("Thêm mới tên lĩnh vực hoạt động")
        $('#maSoHide').removeClass('d-none')
