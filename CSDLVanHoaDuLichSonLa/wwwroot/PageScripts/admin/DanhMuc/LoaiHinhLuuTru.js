...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình lưu trú <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình lưu trú");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình lưu trú ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình lưu trú <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình lưu trú");
        $('#modalAddTitle').text("Thêm mới tên loại hình lưu trú")
        $('#maSoHide').removeClass('d-none')
