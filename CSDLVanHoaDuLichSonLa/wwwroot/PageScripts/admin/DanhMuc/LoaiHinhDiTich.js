...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình di tích <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình di tích");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình di tích ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình di tích <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình di tích");
        $('#modalAddTitle').text("Thêm mới tên loại hình di tích")
        $('#maSoHide').removeClass('d-none')
