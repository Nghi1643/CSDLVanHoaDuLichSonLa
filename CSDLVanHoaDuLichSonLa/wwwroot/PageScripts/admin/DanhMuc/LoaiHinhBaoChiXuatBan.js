...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình báo chí xuất bản <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình báo chí xuất bản");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình báo chí xuất bản ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình báo chí xuất bản <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình báo chí xuất bản");
        $('#modalAddTitle').text("Thêm mới tên loại hình báo chí xuất bản")
        $('#maSoHide').removeClass('d-none')
