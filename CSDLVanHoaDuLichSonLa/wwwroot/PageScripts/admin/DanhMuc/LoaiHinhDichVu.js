...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình dịch vụ <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình dịch vụ");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình dịch vụ ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình dịch vụ <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình dịch vụ");
        $('#modalAddTitle').text("Thêm mới tên loại hình dịch vụ")
        $('#maSoHide').removeClass('d-none')
