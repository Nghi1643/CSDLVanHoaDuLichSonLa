...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên lĩnh vực xuất bản <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên lĩnh vực xuất bản");
            $('#modalAddTitle').text(`Chỉnh sửa tên lĩnh vực xuất bản ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên lĩnh vực xuất bản <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên lĩnh vực xuất bản");
        $('#modalAddTitle').text("Thêm mới tên lĩnh vực xuất bản")
        $('#maSoHide').removeClass('d-none')
