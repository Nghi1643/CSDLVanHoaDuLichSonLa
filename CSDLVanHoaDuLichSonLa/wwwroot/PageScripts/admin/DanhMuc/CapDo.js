...
$(document).ready(function () {
    ...
    function initValidation() {
        ...
        CheckLengthEach('#tenDanhMucAdd', 255, null); // Giới hạn 255 ký tự cho tên danh mục  
...
1576
        const tableCols = [
            ...
            { "data": "tenNgonNgu", "width": "120px", "class": "left-align" },
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên cấp độ sự kiện/hoạt động <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên cấp độ sự kiện/hoạt động");
            $('#modalAddTitle').text(`Chỉnh sửa cấp độ sự kiện/hoạt động ${data.tenDanhMuc}`)
            $('#modalAdd').modal('show');
        });
    ...
    $('#openModalAdd').on("click", function () {
        ...
        $('#modalAddTitle').text("Thêm mới cấp độ sự kiện/hoạt động")
