...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại chất liệu <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại chất liệu");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại chất liệu ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại chất liệu <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại chất liệu");
        $('#modalAddTitle').text("Thêm mới tên loại chất liệu")
        $('#maSoHide').removeClass('d-none')
