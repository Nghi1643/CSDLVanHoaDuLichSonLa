...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại nhân sự <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại nhân sự");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại nhân sự ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại nhân sự <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại nhân sự");
        $('#modalAddTitle').text("Thêm mới tên loại nhân sự")
        $('#maSoHide').removeClass('d-none')
