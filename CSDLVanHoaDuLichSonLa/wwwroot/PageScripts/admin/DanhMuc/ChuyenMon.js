...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên chuyên môn <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên chuyên môn");
            $('#modalAddTitle').text(`Chỉnh sửa tên chuyên môn ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên chuyên môn <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên chuyên môn");
        $('#modalAddTitle').text("Thêm mới tên chuyên môn")
        $('#maSoHide').removeClass('d-none')
