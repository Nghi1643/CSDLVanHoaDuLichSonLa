...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình phi vật thể <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình phi vật thể");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình phi vật thể ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình phi vật thể <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình phi vật thể");
        $('#modalAddTitle').text("Thêm mới tên loại hình phi vật thể")
        $('#maSoHide').removeClass('d-none')
