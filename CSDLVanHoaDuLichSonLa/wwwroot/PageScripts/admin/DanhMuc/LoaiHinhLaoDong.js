...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình lao động <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình lao động");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình lao động ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình lao động <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình lao động");
        $('#modalAddTitle').text("Thêm mới tên loại hình lao động")
        $('#maSoHide').removeClass('d-none')
