...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tần suất hoạt động <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tần suất hoạt động");
            $('#modalAddTitle').text(`Chỉnh sửa tần suất hoạt động ${data.tenDanhMuc}`)
            $('#modalAdd').modal('show');
        });
    ...
    $('#openModalAdd').on("click", function () {
        ...
        $('#modalAddTitle').text("Thêm mới tần suất hoạt động")
