...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình môn thể thao <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình môn thể thao");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình môn thể thao ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình môn thể thao <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình môn thể thao");
        $('#modalAddTitle').text("Thêm mới tên loại hình môn thể thao")
        $('#maSoHide').removeClass('d-none')
