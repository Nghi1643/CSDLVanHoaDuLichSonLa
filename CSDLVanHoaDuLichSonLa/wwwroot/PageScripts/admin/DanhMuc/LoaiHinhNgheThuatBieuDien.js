...
1576
        ...
        $('#dataGrid tbody').on('click', '.edit-command-btn', async function () {
            ...
            $('#labelTenDanhMuc').html('Tên loại hình nghệ thuật biểu diễn <span class="text-red">*</span>')
            $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình nghệ thuật biểu diễn");
            $('#modalAddTitle').text(`Chỉnh sửa tên loại hình nghệ thuật biểu diễn ${data.tenDanhMuc}`)
    ...
    $('#openModalAdd').on("click", function () {
        $('#labelTenDanhMuc').html('Tên loại hình nghệ thuật biểu diễn <span class="text-red">*</span>')
        $("#tenDanhMucAdd").attr("placeholder", "Nhập tên loại hình nghệ thuật biểu diễn");
        $('#modalAddTitle').text("Thêm mới tên loại hình nghệ thuật biểu diễn")
        $('#maSoHide').removeClass('d-none')
